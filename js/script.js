...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // Keep the page-level active link stable while scrolling.
  ...
  // Keep the floating WhatsApp control to one desktop and one mobile action.
  const floatingWhatsapp = document.querySelector('.floating-whatsapp');
  if (floatingWhatsapp) {
    ['.whatsapp-btn-desktop', '.whatsapp-btn-mobile', '.whatsapp-tooltip'].forEach((selector) => {
      Array.from(floatingWhatsapp.querySelectorAll(selector)).slice(1).forEach((element) => element.remove());
    });
  }
  ...
  const serviceDetails = {
    "enterprise-networking": {
      ...
      img: "images/ict-computer-components.png",
    ...
    "custom-software": {
      ...
      img: "images/ict-office-equipment.png",
    ...
    "electrical-power": {
      ...
      img: "images/solar-installation-services.png",
    ...
    "solar-energy": {
      ...
      img: "images/solar-systems-installation.png",
    ...
    "fire-detection": {
      ...
      img: "images/executive-office-desk.png",
    ...
    "corporate-procurement": {
      ...
      img: "images/jarecha-office-furniture-delivery.png",
    ...
    "corporate-training": {
      ...
      img: "images/jarecha-branding-vehicles.png",
